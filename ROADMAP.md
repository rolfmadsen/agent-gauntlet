...
| **8** | **NPM / NPX Distribution Wrapper (`npx agent-gauntlet`)** | Zero-setup distribution via npm/npx (`packages/agent-gauntlet`) for øjeblikkelig eksekvering i JS/TS projekter | [Task 034](tasks/034-npm-and-npx-distribution-wrapper.md) | **KLARGJORT (Task 034)** |
| **9** | **Spec $\to$ Test Mapping & "Must NOT" Validator** | Mekanisk 1:1 håndhævelse af at alle Gherkin-scenarier og negative begrænsninger ("Must NOT") har specifikke tests | [`templates.md`](../old-coder/skills/old-coder/references/templates.md) | **HØJ** |
| **10** | **Fresh-Context Adversarial Verifier** | Uafhængig sub-agent i ren session, der blindt angriber koden for blinde vinkler, test-gaming og spec-drift | [`verifier.md`](../old-coder/skills/old-coder/references/verifier.md), [`verifier-case-study.md`](../old-coder/skills/old-coder/references/verifier-case-study.md) | **MEDIUM** |
| **11** | **Extended Security & Supply-Chain Audits** | Automatiserede gauntlet-lag for `secret-scan` (`gitleaks`) og pakkesårbarheder (`pip-audit`, `npm audit`, `cargo-audit`) | [`gauntlet.md`](../old-coder/skills/old-coder/references/gauntlet.md) | **MEDIUM** |
| **12** | **Suite Health & Test-Order Randomizer** | Randomiseret testrækkefølge med deterministisk seed for at afsløre globale tilstandslækager og flakiness | [`gauntlet.md`](../old-coder/skills/old-coder/references/gauntlet.md) | **LAV** |
