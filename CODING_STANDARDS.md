# Coding Standards: Polyglot (Python & TypeScript & React & Rust)
...
## 2. Python Standards
Subsystems written in Python follow the **Google Python Style Guide**:
...
## 5. Cross-Stack Boundary & Interop Invariants
